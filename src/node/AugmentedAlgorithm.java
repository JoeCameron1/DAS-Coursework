...
/**
 * Implements augmented Chang and Roberts(ring leader election) algorithm.
 */
public class AugmentedAlgorithm extends AbstractNode {
    /**
     * Constructor for a node which uses our augmented algorithm.
     *
     ...
     */
    public AugmentedAlgorithm(int id, AtomicInteger messageCount) throws RemoteException {
     ...
     * Else If this node started the election, then assign the leader and send an elected message to the next node.
